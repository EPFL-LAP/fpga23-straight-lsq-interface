...
-- File created: Sun Nov 27 21:08:19 2022
...
architecture behavioral of getTanh is 
	...
	signal forkC_6_nReadyArray_5 : std_logic;
	signal forkC_6_validArray_5 : std_logic;
	signal forkC_6_dataOutArray_5 : std_logic_vector(0 downto 0);
...
begin
	...
	cst_7_clk <= clk;
	cst_7_rst <= rst;
	branchC_0_pValidArray_1 <= cst_7_validArray_0;
	cst_7_nReadyArray_0 <= branchC_0_readyArray_1;
	branchC_0_dataInArray_1 <= std_logic_vector (resize(unsigned(cst_7_dataOutArray_0),branchC_0_dataInArray_1'length));

	cst_9_clk <= clk;
	cst_9_rst <= rst;
	phi_n10_pValidArray_0 <= cst_9_validArray_0;
	cst_9_nReadyArray_0 <= phi_n10_readyArray_0;
	phi_n10_dataInArray_0 <= std_logic_vector (resize(unsigned(cst_9_dataOutArray_0),phi_n10_dataInArray_0'length));
	...
	phiC_4_pValidArray_2 <= forkC_5_validArray_1;
	forkC_5_nReadyArray_1 <= phiC_4_readyArray_2;
	phiC_4_dataInArray_2 <= std_logic_vector (resize(unsigned(forkC_5_dataOutArray_1),phiC_4_dataInArray_2'length));
	cst_9_pValidArray_0 <= forkC_5_validArray_2;
	forkC_5_nReadyArray_2 <= cst_9_readyArray_0;
	cst_9_dataInArray_0 <= "00000000000000000000000000000001";
	branchC_0_pValidArray_0 <= forkC_5_validArray_3;
	forkC_5_nReadyArray_3 <= branchC_0_readyArray_0;
	branchC_0_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_5_dataOutArray_3),branchC_0_dataInArray_0'length));
	cst_7_pValidArray_0 <= forkC_5_validArray_4;
	forkC_5_nReadyArray_4 <= cst_7_readyArray_0;
	...
	load_4_clk <= clk;
	load_4_rst <= rst;
	fork_13_pValidArray_0 <= load_4_validArray_0;
	load_4_nReadyArray_0 <= fork_13_readyArray_0;
	fork_13_dataInArray_0 <= std_logic_vector (resize(unsigned(load_4_dataOutArray_0),fork_13_dataInArray_0'length));
	...
	load_7_clk <= clk;
	load_7_rst <= rst;
	fork_14_pValidArray_0 <= load_7_validArray_0;
	load_7_nReadyArray_0 <= fork_14_readyArray_0;
	fork_14_dataInArray_0 <= std_logic_vector (resize(unsigned(load_7_dataOutArray_0),fork_14_dataInArray_0'length));
	...
	cst_1_clk <= clk;
	cst_1_rst <= rst;
	Buffer_2_pValidArray_0 <= cst_1_validArray_0;
	cst_1_nReadyArray_0 <= Buffer_2_readyArray_0;
	Buffer_2_dataInArray_0 <= std_logic_vector (resize(unsigned(cst_1_dataOutArray_0),Buffer_2_dataInArray_0'length));
	...
	cst_4_clk <= clk;
	cst_4_rst <= rst;
	Buffer_3_pValidArray_0 <= cst_4_validArray_0;
	cst_4_nReadyArray_0 <= Buffer_3_readyArray_0;
	Buffer_3_dataInArray_0 <= std_logic_vector (resize(unsigned(cst_4_dataOutArray_0),Buffer_3_dataInArray_0'length));

	phiC_0_clk <= clk;
	phiC_0_rst <= rst;
	forkC_10_pValidArray_0 <= phiC_0_validArray_0;
	phiC_0_nReadyArray_0 <= forkC_10_readyArray_0;
	forkC_10_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_0_dataOutArray_0),forkC_10_dataInArray_0'length));

	branchC_1_clk <= clk;
	branchC_1_rst <= rst;
	phiC_2_pValidArray_1 <= branchC_1_validArray_0;
	branchC_1_nReadyArray_0 <= phiC_2_readyArray_1;
	phiC_2_dataInArray_1 <= std_logic_vector (resize(unsigned(branchC_1_dataOutArray_0),phiC_2_dataInArray_1'length));
	phiC_1_pValidArray_0 <= branchC_1_validArray_1;
	branchC_1_nReadyArray_1 <= phiC_1_readyArray_0;
	phiC_1_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_1_dataOutArray_1),phiC_1_dataInArray_0'length));
	...
	phi_n10_clk <= clk;
	phi_n10_rst <= rst;
	fork_7_pValidArray_0 <= phi_n10_validArray_0;
	phi_n10_nReadyArray_0 <= fork_7_readyArray_0;
	fork_7_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n10_dataOutArray_0),fork_7_dataInArray_0'length));
	...
	fork_8_pValidArray_0 <= branch_5_validArray_1;
	branch_5_nReadyArray_1 <= fork_8_readyArray_0;
	fork_8_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_5_dataOutArray_1),fork_8_dataInArray_0'length));
	...
	Buffer_5_pValidArray_0 <= branch_9_validArray_1;
	branch_9_nReadyArray_1 <= Buffer_5_readyArray_0;
	Buffer_5_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_9_dataOutArray_1),Buffer_5_dataInArray_0'length));
	...
	Buffer_6_pValidArray_0 <= branchC_11_validArray_1;
	branchC_11_nReadyArray_1 <= Buffer_6_readyArray_0;
	Buffer_6_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_11_dataOutArray_1),Buffer_6_dataInArray_0'length));

	branchC_13_clk <= clk;
	branchC_13_rst <= rst;
	sink_8_pValidArray_0 <= branchC_13_validArray_0;
	branchC_13_nReadyArray_0 <= sink_8_readyArray_0;
	sink_8_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_13_dataOutArray_0),sink_8_dataInArray_0'length));
	...
	branch_9_pValidArray_1 <= fork_1_validArray_1;
	fork_1_nReadyArray_1 <= branch_9_readyArray_1;
	branch_9_dataInArray_1 <= not std_logic_vector (resize(unsigned(fork_1_dataOutArray_1),branch_9_dataInArray_1'length));
	branchC_11_pValidArray_1 <= fork_1_validArray_2;
	fork_1_nReadyArray_2 <= branchC_11_readyArray_1;
	branchC_11_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_1_dataOutArray_2),branchC_11_dataInArray_1'length));
	Buffer_7_pValidArray_0 <= fork_1_validArray_3;
	fork_1_nReadyArray_3 <= Buffer_7_readyArray_0;
	Buffer_7_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_1_dataOutArray_3),Buffer_7_dataInArray_0'length));
	branchC_1_pValidArray_1 <= fork_1_validArray_4;
	fork_1_nReadyArray_4 <= branchC_1_readyArray_1;
	branchC_1_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_1_dataOutArray_4),branchC_1_dataInArray_1'length));

	forkC_6_clk <= clk;
	forkC_6_rst <= rst;
	cst_1_pValidArray_0 <= forkC_6_validArray_0;
	forkC_6_nReadyArray_0 <= cst_1_readyArray_0;
	cst_1_dataInArray_0 <= "00000000000000000000000000000000";
	branchC_13_pValidArray_0 <= forkC_6_validArray_1;
	forkC_6_nReadyArray_1 <= branchC_13_readyArray_0;
	branchC_13_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_6_dataOutArray_1),branchC_13_dataInArray_0'length));
	Buffer_8_pValidArray_0 <= forkC_6_validArray_2;
	forkC_6_nReadyArray_2 <= Buffer_8_readyArray_0;
	Buffer_8_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_6_dataOutArray_2),Buffer_8_dataInArray_0'length));
	cst_4_pValidArray_0 <= forkC_6_validArray_3;
	forkC_6_nReadyArray_3 <= cst_4_readyArray_0;
	cst_4_dataInArray_0 <= "00000000000000000000000000000001";
	cst_5_pValidArray_0 <= forkC_6_validArray_4;
	forkC_6_nReadyArray_4 <= cst_5_readyArray_0;
	cst_5_dataInArray_0 <= "00000000000000000000000000000001";
	cst_6_pValidArray_0 <= forkC_6_validArray_5;
	forkC_6_nReadyArray_5 <= cst_6_readyArray_0;
	cst_6_dataInArray_0 <= "00000000000000000000001111101000";

	fork_7_clk <= clk;
	fork_7_rst <= rst;
	phi_1_pValidArray_0 <= fork_7_validArray_0;
	fork_7_nReadyArray_0 <= phi_1_readyArray_0;
	phi_1_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_7_dataOutArray_0),phi_1_dataInArray_0'length));
	phiC_4_pValidArray_0 <= fork_7_validArray_1;
	fork_7_nReadyArray_1 <= phiC_4_readyArray_0;
	phiC_4_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_7_dataOutArray_1),phiC_4_dataInArray_0'length));

	forkC_10_clk <= clk;
	forkC_10_rst <= rst;
	Buffer_9_pValidArray_0 <= forkC_10_validArray_0;
	forkC_10_nReadyArray_0 <= Buffer_9_readyArray_0;
	Buffer_9_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_10_dataOutArray_0),Buffer_9_dataInArray_0'length));
	LSQ_A_pValidArray_0 <= forkC_10_validArray_1;
	forkC_10_nReadyArray_1 <= LSQ_A_readyArray_0;
	LSQ_A_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_10_dataOutArray_1),LSQ_A_dataInArray_0'length));

	fork_13_clk <= clk;
	fork_13_rst <= rst;
	load_7_pValidArray_1 <= fork_13_validArray_0;
	fork_13_nReadyArray_0 <= load_7_readyArray_1;
	load_7_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_13_dataOutArray_0),load_7_dataInArray_1'length));
	...
	fork_14_clk <= clk;
	fork_14_rst <= rst;
	icmp_8_pValidArray_0 <= fork_14_validArray_0;
	fork_14_nReadyArray_0 <= icmp_8_readyArray_0;
	icmp_8_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_14_dataOutArray_0),icmp_8_dataInArray_0'length));
	branch_5_pValidArray_0 <= fork_14_validArray_1;
	fork_14_nReadyArray_1 <= branch_5_readyArray_0;
	branch_5_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_14_dataOutArray_1),branch_5_dataInArray_0'length));
	...
	Buffer_2_clk <= clk;
	Buffer_2_rst <= rst;
	icmp_8_pValidArray_1 <= Buffer_2_validArray_0;
	Buffer_2_nReadyArray_0 <= icmp_8_readyArray_1;
	icmp_8_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_2_dataOutArray_0),icmp_8_dataInArray_1'length));

	Buffer_3_clk <= clk;
	Buffer_3_rst <= rst;
	branch_9_pValidArray_0 <= Buffer_3_validArray_0;
	Buffer_3_nReadyArray_0 <= branch_9_readyArray_0;
	branch_9_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_3_dataOutArray_0),branch_9_dataInArray_0'length));

	Buffer_4_clk <= clk;
	Buffer_4_rst <= rst;
	forkC_6_pValidArray_0 <= Buffer_4_validArray_0;
	Buffer_4_nReadyArray_0 <= forkC_6_readyArray_0;
	forkC_6_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_4_dataOutArray_0),forkC_6_dataInArray_0'length));

	Buffer_5_clk <= clk;
	Buffer_5_rst <= rst;
	phi_16_pValidArray_2 <= Buffer_5_validArray_0;
	Buffer_5_nReadyArray_0 <= phi_16_readyArray_2;
	phi_16_dataInArray_2 <= std_logic_vector (resize(unsigned(Buffer_5_dataOutArray_0),phi_16_dataInArray_2'length));

	Buffer_6_clk <= clk;
	Buffer_6_rst <= rst;
	forkC_9_pValidArray_0 <= Buffer_6_validArray_0;
	Buffer_6_nReadyArray_0 <= forkC_9_readyArray_0;
	forkC_9_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_6_dataOutArray_0),forkC_9_dataInArray_0'length));

	Buffer_7_clk <= clk;
	Buffer_7_rst <= rst;
	phi_16_pValidArray_0 <= Buffer_7_validArray_0;
	Buffer_7_nReadyArray_0 <= phi_16_readyArray_0;
	phi_16_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_7_dataOutArray_0),phi_16_dataInArray_0'length));
	...
	Buffer_9_clk <= clk;
	Buffer_9_rst <= rst;
	branchC_1_pValidArray_0 <= Buffer_9_validArray_0;
	Buffer_9_nReadyArray_0 <= branchC_1_readyArray_0;
	branchC_1_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_9_dataOutArray_0),branchC_1_dataInArray_0'length));
	...
	cst_3_clk <= clk;
	cst_3_rst <= rst;
	Buffer_10_pValidArray_0 <= cst_3_validArray_0;
	cst_3_nReadyArray_0 <= Buffer_10_readyArray_0;
	Buffer_10_dataInArray_0 <= std_logic_vector (resize(unsigned(cst_3_dataOutArray_0),Buffer_10_dataInArray_0'length));
	...
	phiC_1_clk <= clk;
	phiC_1_rst <= rst;
	forkC_11_pValidArray_0 <= phiC_1_validArray_0;
	phiC_1_nReadyArray_0 <= forkC_11_readyArray_0;
	forkC_11_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_1_dataOutArray_0),forkC_11_dataInArray_0'length));
	...
	sink_2_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_2_dataOutArray_1),sink_2_dataInArray_0'length));

	cst_8_clk <= clk;
	cst_8_rst <= rst;
	branchC_2_pValidArray_1 <= cst_8_validArray_0;
	cst_8_nReadyArray_0 <= branchC_2_readyArray_1;
	branchC_2_dataInArray_1 <= std_logic_vector (resize(unsigned(cst_8_dataOutArray_0),branchC_2_dataInArray_1'length));
	...
	Buffer_11_pValidArray_0 <= fork_8_validArray_2;
	fork_8_nReadyArray_2 <= Buffer_11_readyArray_0;
	Buffer_11_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_8_dataOutArray_2),Buffer_11_dataInArray_0'length));
	Buffer_12_pValidArray_0 <= fork_8_validArray_3;
	fork_8_nReadyArray_3 <= Buffer_12_readyArray_0;
	Buffer_12_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_8_dataOutArray_3),Buffer_12_dataInArray_0'length));
	...
	cst_3_pValidArray_0 <= forkC_9_validArray_1;
	forkC_9_nReadyArray_1 <= cst_3_readyArray_0;
	cst_3_dataInArray_0 <= "00000000000000000000000000000011";

	forkC_11_clk <= clk;
	forkC_11_rst <= rst;
	branchC_2_pValidArray_0 <= forkC_11_validArray_0;
	forkC_11_nReadyArray_0 <= branchC_2_readyArray_0;
	branchC_2_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_11_dataOutArray_0),branchC_2_dataInArray_0'length));
	cst_8_pValidArray_0 <= forkC_11_validArray_1;
	forkC_11_nReadyArray_1 <= cst_8_readyArray_0;
	cst_8_dataInArray_0 <= "00000000000000000000000000000001";

	Buffer_10_clk <= clk;
	Buffer_10_rst <= rst;
	add_13_pValidArray_1 <= Buffer_10_validArray_0;
	Buffer_10_nReadyArray_0 <= add_13_readyArray_1;
	add_13_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_10_dataOutArray_0),add_13_dataInArray_1'length));

	Buffer_11_clk <= clk;
	Buffer_11_rst <= rst;
	mul_12_pValidArray_1 <= Buffer_11_validArray_0;
	Buffer_11_nReadyArray_0 <= mul_12_readyArray_1;
	mul_12_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_11_dataOutArray_0),mul_12_dataInArray_1'length));

	Buffer_12_clk <= clk;
	Buffer_12_rst <= rst;
	mul_14_pValidArray_1 <= Buffer_12_validArray_0;
	Buffer_12_nReadyArray_0 <= mul_14_readyArray_1;
	mul_14_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_12_dataOutArray_0),mul_14_dataInArray_1'length));
	...
	phiC_2_clk <= clk;
	phiC_2_rst <= rst;
	forkC_12_pValidArray_0 <= phiC_2_validArray_0;
	phiC_2_nReadyArray_0 <= forkC_12_readyArray_0;
	forkC_12_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_2_dataOutArray_0),forkC_12_dataInArray_0'length));

	branchC_3_clk <= clk;
	branchC_3_rst <= rst;
	phiC_0_pValidArray_1 <= branchC_3_validArray_0;
	branchC_3_nReadyArray_0 <= phiC_0_readyArray_1;
	phiC_0_dataInArray_1 <= std_logic_vector (resize(unsigned(branchC_3_dataOutArray_0),phiC_0_dataInArray_1'length));
	...
	phi_1_pValidArray_1 <= branch_4_validArray_1;
	branch_4_nReadyArray_1 <= phi_1_readyArray_1;
	phi_1_dataInArray_1 <= std_logic_vector (resize(unsigned(branch_4_dataOutArray_1),phi_1_dataInArray_1'length));

	branch_10_clk <= clk;
	branch_10_rst <= rst;
	sink_6_pValidArray_0 <= branch_10_validArray_0;
	branch_10_nReadyArray_0 <= sink_6_readyArray_0;
	sink_6_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_10_dataOutArray_0),sink_6_dataInArray_0'length));
	...
	branch_10_pValidArray_0 <= fork_2_validArray_1;
	fork_2_nReadyArray_1 <= branch_10_readyArray_0;
	branch_10_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_2_dataOutArray_1),branch_10_dataInArray_0'length));
	...
	branch_4_pValidArray_0 <= fork_3_validArray_1;
	fork_3_nReadyArray_1 <= branch_4_readyArray_0;
	branch_4_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_3_dataOutArray_1),branch_4_dataInArray_0'length));

	fork_4_clk <= clk;
	fork_4_rst <= rst;
	branch_4_pValidArray_1 <= fork_4_validArray_0;
	fork_4_nReadyArray_0 <= branch_4_readyArray_1;
	branch_4_dataInArray_1 <= not std_logic_vector (resize(unsigned(fork_4_dataOutArray_0),branch_4_dataInArray_1'length));
	phi_n10_pValidArray_1 <= fork_4_validArray_1;
	fork_4_nReadyArray_1 <= phi_n10_readyArray_1;
	phi_n10_dataInArray_1 <= not std_logic_vector (resize(unsigned(fork_4_dataOutArray_1),phi_n10_dataInArray_1'length));
	...
	branchC_13_pValidArray_1 <= fork_4_validArray_3;
	fork_4_nReadyArray_3 <= branchC_13_readyArray_1;
	branchC_13_dataInArray_1 <= not std_logic_vector (resize(unsigned(fork_4_dataOutArray_3),branchC_13_dataInArray_1'length));
	Buffer_13_pValidArray_0 <= fork_4_validArray_4;
	fork_4_nReadyArray_4 <= Buffer_13_readyArray_0;
	Buffer_13_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_4_dataOutArray_4),Buffer_13_dataInArray_0'length));

	forkC_12_clk <= clk;
	forkC_12_rst <= rst;
	Buffer_15_pValidArray_0 <= forkC_12_validArray_0;
	forkC_12_nReadyArray_0 <= Buffer_15_readyArray_0;
	Buffer_15_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_12_dataOutArray_0),Buffer_15_dataInArray_0'length));
	LSQ_A_pValidArray_1 <= forkC_12_validArray_1;
	forkC_12_nReadyArray_1 <= LSQ_A_readyArray_1;
	LSQ_A_dataInArray_1 <= std_logic_vector (resize(unsigned(forkC_12_dataOutArray_1),LSQ_A_dataInArray_1'length));

	Buffer_13_clk <= clk;
	Buffer_13_rst <= rst;
	branchC_3_pValidArray_1 <= Buffer_13_validArray_0;
	Buffer_13_nReadyArray_0 <= branchC_3_readyArray_1;
	branchC_3_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_13_dataOutArray_0),branchC_3_dataInArray_1'length));

	Buffer_14_clk <= clk;
	Buffer_14_rst <= rst;
	branch_10_pValidArray_1 <= Buffer_14_validArray_0;
	Buffer_14_nReadyArray_0 <= branch_10_readyArray_1;
	branch_10_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_14_dataOutArray_0),branch_10_dataInArray_1'length));

	Buffer_15_clk <= clk;
	Buffer_15_rst <= rst;
	branchC_3_pValidArray_0 <= Buffer_15_validArray_0;
	Buffer_15_nReadyArray_0 <= branchC_3_readyArray_0;
	branchC_3_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_15_dataOutArray_0),branchC_3_dataInArray_0'length));
	...
	phiC_3_clk <= clk;
	phiC_3_rst <= rst;
	sink_0_pValidArray_0 <= phiC_3_validArray_0;
	phiC_3_nReadyArray_0 <= sink_0_readyArray_0;
	sink_0_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_3_dataOutArray_0),sink_0_dataInArray_0'length));
...
forkC_6: entity work.fork(arch) generic map (1,6,1,1)
port map (
	clk => forkC_6_clk,
	rst => forkC_6_rst,
	...
	nReadyArray(5) => forkC_6_nReadyArray_5,
	...
	validArray(5) => forkC_6_validArray_5,
	...
	dataOutArray(5) => forkC_6_dataOutArray_5
);
...
Buffer_2: entity work.transpFifo(arch) generic map (1,1,32,32,7)
port map (
	clk => Buffer_2_clk,
	rst => Buffer_2_rst,
...
Buffer_3: entity work.transpFifo(arch) generic map (1,1,32,32,7)
port map (
	clk => Buffer_3_clk,
	rst => Buffer_3_rst,
...
Buffer_5: entity work.transpFifo(arch) generic map (1,1,32,32,12)
port map (
	clk => Buffer_5_clk,
	rst => Buffer_5_rst,
...
Buffer_8: entity work.transpFifo(arch) generic map (1,1,1,1,7)
port map (
	clk => Buffer_8_clk,
	rst => Buffer_8_rst,
...
forkC_11: entity work.fork(arch) generic map (1,2,1,1)
port map (
	clk => forkC_11_clk,
	rst => forkC_11_rst,
...
forkC_12: entity work.fork(arch) generic map (1,2,1,1)
port map (
	clk => forkC_12_clk,
	rst => forkC_12_rst,
...
Buffer_13: entity work.transpFifo(arch) generic map (1,1,32,32,7)
port map (
	clk => Buffer_13_clk,
	rst => Buffer_13_rst,
...
Buffer_14: entity work.transpFifo(arch) generic map (1,1,32,32,19)
port map (
	clk => Buffer_14_clk,
	rst => Buffer_14_rst,
