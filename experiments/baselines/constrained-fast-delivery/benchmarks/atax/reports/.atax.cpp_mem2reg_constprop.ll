...
for.body:                                         ; preds = %entry, %for.inc28
  %i.04 = phi i32 [ 0, %entry ], [ %inc29, %for.inc28 ]
...
for.body3:                                        ; preds = %for.body, %for.inc
  %t.02 = phi i32 [ %0, %for.body ], [ %add, %for.inc ]
...
for.body12:                                       ; preds = %for.end, %for.inc23
  %j.13 = phi i32 [ 0, %for.end ], [ %inc24, %for.inc23 ]
...
for.end30:                                        ; preds = %for.inc28
  %i.0.lcssa = phi i32 [ %inc29, %for.inc28 ]
  ret i32 %i.0.lcssa
}
...
for.body17:                                       ; preds = %for.body3, %for.inc
  %x14.01 = phi i32 [ 0, %for.body3 ], [ %inc, %for.inc ]
