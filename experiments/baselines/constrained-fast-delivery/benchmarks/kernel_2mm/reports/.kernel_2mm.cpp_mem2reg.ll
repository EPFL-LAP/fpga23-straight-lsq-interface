...
for.cond:                                         ; preds = %for.inc25, %entry
  ...
  %k.0 = phi i32 [ undef, %entry ], [ %k.1, %for.inc25 ]
...
for.cond1:                                        ; preds = %for.inc22, %for.body
  ...
  %k.1 = phi i32 [ %k.0, %for.body ], [ %k.2, %for.inc22 ]
...
for.cond6:                                        ; preds = %for.inc, %for.body3
  %k.2 = phi i32 [ 0, %for.body3 ], [ %inc, %for.inc ]
  %x.0 = phi i32 [ %0, %for.body3 ], [ %add, %for.inc ]
  %cmp7 = icmp slt i32 %k.2, 10
  br i1 %cmp7, label %for.body8, label %for.end

for.body8:                                        ; preds = %for.cond6
  %idxprom9 = sext i32 %i.0 to i64
  %arrayidx10 = getelementptr inbounds [10 x i32], [10 x i32]* %A, i64 %idxprom9
  %idxprom11 = sext i32 %k.2 to i64
...
for.end:                                          ; preds = %for.cond6
  ...
  store i32 %x.0, i32* %arrayidx21, align 4
  br label %for.inc22
...
for.cond28:                                       ; preds = %for.inc63, %for.end27
  ...
  %k.3 = phi i32 [ %k.0, %for.end27 ], [ %k.4, %for.inc63 ]
...
for.cond31:                                       ; preds = %for.inc60, %for.body30
  %j.1 = phi i32 [ 0, %for.body30 ], [ %inc61, %for.inc60 ]
  %k.4 = phi i32 [ %k.3, %for.body30 ], [ %k.5, %for.inc60 ]
...
for.cond40:                                       ; preds = %for.inc53, %for.body33
  %k.5 = phi i32 [ 0, %for.body33 ], [ %inc54, %for.inc53 ]
  %x34.0 = phi i32 [ %mul39, %for.body33 ], [ %add52, %for.inc53 ]
  %cmp41 = icmp slt i32 %k.5, 10
...
for.body42:                                       ; preds = %for.cond40
  ...
  %add52 = add nsw i32 %x34.0, %mul51
  br label %for.inc53

for.inc53:                                        ; preds = %for.body42
  %inc54 = add nsw i32 %k.5, 1
  br label %for.cond40
...
for.end55:                                        ; preds = %for.cond40
  ...
  store i32 %x34.0, i32* %arrayidx59, align 4
  br label %for.inc60
