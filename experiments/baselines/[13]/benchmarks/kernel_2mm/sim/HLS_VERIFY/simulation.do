...
project addfile ../VHDL_SRC/kernel_2mm_optimized.vhd
project addfile ../VHDL_SRC/elastic_components.vhd
project addfile ../VHDL_SRC/mul_wrapper.vhd
project addfile ../VHDL_SRC/hls_verify_kernel_2mm_tb.vhd
...
project addfile ../VHDL_SRC/LSQ_tmp.v
project calculateorder
project compileall
eval vsim kernel_2mm_tb
run -all
exit
