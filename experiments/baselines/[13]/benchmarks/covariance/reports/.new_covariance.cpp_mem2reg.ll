; ModuleID = '.new_covariance.cpp.ll'
...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %m.0 = phi i32 [ 0, %for.body ], [ %add, %for.inc ]
...
for.end:                                          ; preds = %for.cond1
  %mul = mul nsw i32 %m.0, 2
  br label %for.cond7

for.cond7:                                        ; preds = %for.inc14, %for.end
  %i6.0 = phi i32 [ 0, %for.end ], [ %inc15, %for.inc14 ]
  %cmp8 = icmp slt i32 %i6.0, 32
...
for.cond21:                                       ; preds = %for.inc52, %for.end19
  %i20.0 = phi i32 [ 0, %for.end19 ], [ %inc53, %for.inc52 ]
  %cmp22 = icmp slt i32 %i20.0, 32
...
for.cond25:                                       ; preds = %for.inc49, %for.body23
  %j24.0 = phi i32 [ %i20.0, %for.body23 ], [ %inc50, %for.inc49 ]
  %cmp26 = icmp slt i32 %j24.0, 32
...
for.cond28:                                       ; preds = %for.inc41, %for.body27
  %c.0 = phi i32 [ 0, %for.body27 ], [ %add40, %for.inc41 ]
  %k.0 = phi i32 [ 0, %for.body27 ], [ %inc42, %for.inc41 ]
...
for.body30:                                       ; preds = %for.cond28
  ...
  %idxprom37 = sext i32 %j24.0 to i64
...
for.end43:                                        ; preds = %for.cond28
  %mul44 = mul nsw i32 %c.0, 2
  %idxprom45 = sext i32 %i20.0 to i64
  %arrayidx46 = getelementptr inbounds [32 x i32], [32 x i32]* %cov, i64 %idxprom45
  %idxprom47 = sext i32 %j24.0 to i64
...
for.cond31:                                       ; preds = %for.inc56, %for.end29
  %j30.0 = phi i32 [ 0, %for.end29 ], [ %inc57, %for.inc56 ]
  %cmp32 = icmp slt i32 %j30.0, 32
...
for.cond35:                                       ; preds = %for.inc42, %for.body33
  %i34.0 = phi i32 [ 0, %for.body33 ], [ %inc43, %for.inc42 ]
  %m.0 = phi i32 [ 0, %for.body33 ], [ %add, %for.inc42 ]
  %cmp36 = icmp slt i32 %i34.0, 32
...
for.cond46:                                       ; preds = %for.inc53, %for.end44
  %i45.0 = phi i32 [ 0, %for.end44 ], [ %inc54, %for.inc53 ]
  %cmp47 = icmp slt i32 %i45.0, 32
...
for.body48:                                       ; preds = %for.cond46
  ...
  %idxprom51 = sext i32 %j30.0 to i64
...
for.cond60:                                       ; preds = %for.inc95, %for.end58
  %i59.0 = phi i32 [ 0, %for.end58 ], [ %inc96, %for.inc95 ]
  %cmp61 = icmp slt i32 %i59.0, 32
...
for.cond64:                                       ; preds = %for.inc92, %for.body62
  %j63.0 = phi i32 [ %i59.0, %for.body62 ], [ %inc93, %for.inc92 ]
  %cmp65 = icmp slt i32 %j63.0, 32
...
for.cond67:                                       ; preds = %for.inc80, %for.body66
  %c.0 = phi i32 [ 0, %for.body66 ], [ %add79, %for.inc80 ]
  %k.0 = phi i32 [ 0, %for.body66 ], [ %inc81, %for.inc80 ]
  %cmp68 = icmp slt i32 %k.0, 32
...
for.body69:                                       ; preds = %for.cond67
  ...
  %idxprom72 = sext i32 %i59.0 to i64
