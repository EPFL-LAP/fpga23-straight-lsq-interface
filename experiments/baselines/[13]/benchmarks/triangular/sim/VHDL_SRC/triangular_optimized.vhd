...
-- File created: Mon Nov 28 17:22:47 2022
...
architecture behavioral of triangular is 
	...
	signal forkC_24_nReadyArray_4 : std_logic;
	signal forkC_24_validArray_4 : std_logic;
	signal forkC_24_dataOutArray_4 : std_logic_vector(0 downto 0);
	signal forkC_24_nReadyArray_5 : std_logic;
	signal forkC_24_validArray_5 : std_logic;
	signal forkC_24_dataOutArray_5 : std_logic_vector(0 downto 0);
	signal forkC_24_nReadyArray_6 : std_logic;
	signal forkC_24_validArray_6 : std_logic;
	signal forkC_24_dataOutArray_6 : std_logic_vector(0 downto 0);
	...
	signal forkC_25_nReadyArray_2 : std_logic;
	signal forkC_25_validArray_2 : std_logic;
	signal forkC_25_dataOutArray_2 : std_logic_vector(0 downto 0);
...
begin
	...
	add_0_clk <= clk;
	add_0_rst <= rst;
	branch_1_pValidArray_0 <= add_0_validArray_0;
	add_0_nReadyArray_0 <= branch_1_readyArray_0;
	branch_1_dataInArray_0 <= std_logic_vector (resize(unsigned(add_0_dataOutArray_0),branch_1_dataInArray_0'length));
	...
	icmp_1_clk <= clk;
	icmp_1_rst <= rst;
	fork_13_pValidArray_0 <= icmp_1_validArray_0;
	icmp_1_nReadyArray_0 <= fork_13_readyArray_0;
	fork_13_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_1_dataOutArray_0),fork_13_dataInArray_0'length));
	...
	branch_0_pValidArray_0 <= fork_0_validArray_2;
	fork_0_nReadyArray_2 <= branch_0_readyArray_0;
	branch_0_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_0_dataOutArray_2),branch_0_dataInArray_0'length));

	branch_0_clk <= clk;
	branch_0_rst <= rst;
	phi_n1_pValidArray_0 <= branch_0_validArray_0;
	branch_0_nReadyArray_0 <= phi_n1_readyArray_0;
	phi_n1_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_0_dataOutArray_0),phi_n1_dataInArray_0'length));
	phi_n2_pValidArray_0 <= branch_0_validArray_1;
	branch_0_nReadyArray_1 <= phi_n2_readyArray_0;
	phi_n2_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_0_dataOutArray_1),phi_n2_dataInArray_0'length));
	...
	phi_28_pValidArray_1 <= branch_1_validArray_1;
	branch_1_nReadyArray_1 <= phi_28_readyArray_1;
	phi_28_dataInArray_1 <= std_logic_vector (resize(unsigned(branch_1_dataOutArray_1),phi_28_dataInArray_1'length));

	fork_13_clk <= clk;
	fork_13_rst <= rst;
	branch_1_pValidArray_1 <= fork_13_validArray_0;
	fork_13_nReadyArray_0 <= branch_1_readyArray_1;
	branch_1_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_13_dataOutArray_0),branch_1_dataInArray_1'length));
	branch_0_pValidArray_1 <= fork_13_validArray_1;
	fork_13_nReadyArray_1 <= branch_0_readyArray_1;
	branch_0_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_13_dataOutArray_1),branch_0_dataInArray_1'length));
	branchC_14_pValidArray_1 <= fork_13_validArray_2;
	fork_13_nReadyArray_2 <= branchC_14_readyArray_1;
	branchC_14_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_13_dataOutArray_2),branchC_14_dataInArray_1'length));
	...
	cst_1_pValidArray_0 <= forkC_20_validArray_1;
	forkC_20_nReadyArray_1 <= cst_1_readyArray_0;
	cst_1_dataInArray_0 <= "00000000000000000000000000000000";
	branchC_14_pValidArray_0 <= forkC_20_validArray_2;
	forkC_20_nReadyArray_2 <= branchC_14_readyArray_0;
	branchC_14_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_20_dataOutArray_2),branchC_14_dataInArray_0'length));

	branchC_14_clk <= clk;
	branchC_14_rst <= rst;
	phiC_10_pValidArray_0 <= branchC_14_validArray_0;
	branchC_14_nReadyArray_0 <= phiC_10_readyArray_0;
	phiC_10_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_14_dataOutArray_0),phiC_10_dataInArray_0'length));
	phiC_15_pValidArray_0 <= branchC_14_validArray_1;
	branchC_14_nReadyArray_1 <= phiC_15_readyArray_0;
	phiC_15_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_14_dataOutArray_1),phiC_15_dataInArray_0'length));

	brCst_block2_clk <= clk;
	brCst_block2_rst <= rst;
	fork_14_pValidArray_0 <= brCst_block2_validArray_0;
	brCst_block2_nReadyArray_0 <= fork_14_readyArray_0;
	fork_14_dataInArray_0 <= std_logic_vector (resize(unsigned(brCst_block2_dataOutArray_0),fork_14_dataInArray_0'length));

	phi_n0_clk <= clk;
	phi_n0_rst <= rst;
	branch_2_pValidArray_0 <= phi_n0_validArray_0;
	phi_n0_nReadyArray_0 <= branch_2_readyArray_0;
	branch_2_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n0_dataOutArray_0),branch_2_dataInArray_0'length));
	...
	fork_14_clk <= clk;
	fork_14_rst <= rst;
	branch_3_pValidArray_1 <= fork_14_validArray_0;
	fork_14_nReadyArray_0 <= branch_3_readyArray_1;
	branch_3_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_14_dataOutArray_0),branch_3_dataInArray_1'length));
	branch_2_pValidArray_1 <= fork_14_validArray_1;
	fork_14_nReadyArray_1 <= branch_2_readyArray_1;
	branch_2_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_14_dataOutArray_1),branch_2_dataInArray_1'length));
	branchC_15_pValidArray_1 <= fork_14_validArray_2;
	fork_14_nReadyArray_2 <= branchC_15_readyArray_1;
	branchC_15_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_14_dataOutArray_2),branchC_15_dataInArray_1'length));
	...
	forkC_21_clk <= clk;
	forkC_21_rst <= rst;
	branchC_15_pValidArray_0 <= forkC_21_validArray_0;
	forkC_21_nReadyArray_0 <= branchC_15_readyArray_0;
	branchC_15_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_21_dataOutArray_0),branchC_15_dataInArray_0'length));
	brCst_block2_pValidArray_0 <= forkC_21_validArray_1;
	forkC_21_nReadyArray_1 <= brCst_block2_readyArray_0;
	brCst_block2_dataInArray_0 <= "1";

	branchC_15_clk <= clk;
	branchC_15_rst <= rst;
	phiC_11_pValidArray_0 <= branchC_15_validArray_0;
	branchC_15_nReadyArray_0 <= phiC_11_readyArray_0;
	phiC_11_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_15_dataOutArray_0),phiC_11_dataInArray_0'length));
	sink_7_pValidArray_0 <= branchC_15_validArray_1;
	branchC_15_nReadyArray_1 <= sink_7_readyArray_0;
	sink_7_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_15_dataOutArray_1),sink_7_dataInArray_0'length));
	...
	icmp_5_clk <= clk;
	icmp_5_rst <= rst;
	fork_15_pValidArray_0 <= icmp_5_validArray_0;
	icmp_5_nReadyArray_0 <= fork_15_readyArray_0;
	fork_15_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_5_dataOutArray_0),fork_15_dataInArray_0'length));

	phi_n3_clk <= clk;
	phi_n3_rst <= rst;
	branch_5_pValidArray_0 <= phi_n3_validArray_0;
	phi_n3_nReadyArray_0 <= branch_5_readyArray_0;
	branch_5_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n3_dataOutArray_0),branch_5_dataInArray_0'length));
	...
	branch_4_pValidArray_0 <= fork_2_validArray_1;
	fork_2_nReadyArray_1 <= branch_4_readyArray_0;
	branch_4_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_2_dataOutArray_1),branch_4_dataInArray_0'length));

	branch_4_clk <= clk;
	branch_4_rst <= rst;
	phi_n6_pValidArray_0 <= branch_4_validArray_0;
	branch_4_nReadyArray_0 <= phi_n6_readyArray_0;
	phi_n6_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_4_dataOutArray_0),phi_n6_dataInArray_0'length));
	Buffer_9_pValidArray_0 <= branch_4_validArray_1;
	branch_4_nReadyArray_1 <= Buffer_9_readyArray_0;
	Buffer_9_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_4_dataOutArray_1),Buffer_9_dataInArray_0'length));
	...
	Buffer_10_pValidArray_0 <= branch_5_validArray_1;
	branch_5_nReadyArray_1 <= Buffer_10_readyArray_0;
	Buffer_10_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_5_dataOutArray_1),Buffer_10_dataInArray_0'length));

	fork_15_clk <= clk;
	fork_15_rst <= rst;
	branch_5_pValidArray_1 <= fork_15_validArray_0;
	fork_15_nReadyArray_0 <= branch_5_readyArray_1;
	branch_5_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_15_dataOutArray_0),branch_5_dataInArray_1'length));
	branch_4_pValidArray_1 <= fork_15_validArray_1;
	fork_15_nReadyArray_1 <= branch_4_readyArray_1;
	branch_4_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_15_dataOutArray_1),branch_4_dataInArray_1'length));
	branchC_16_pValidArray_1 <= fork_15_validArray_2;
	fork_15_nReadyArray_2 <= branchC_16_readyArray_1;
	branchC_16_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_15_dataOutArray_2),branchC_16_dataInArray_1'length));

	phiC_11_clk <= clk;
	phiC_11_rst <= rst;
	Buffer_16_pValidArray_0 <= phiC_11_validArray_0;
	phiC_11_nReadyArray_0 <= Buffer_16_readyArray_0;
	Buffer_16_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_11_dataOutArray_0),Buffer_16_dataInArray_0'length));
	phi_4_pValidArray_0 <= phiC_11_validArray_1;
	phiC_11_nReadyArray_1 <= phi_4_readyArray_0;
	phi_4_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_11_dataOutArray_1),phi_4_dataInArray_0'length));

	forkC_22_clk <= clk;
	forkC_22_rst <= rst;
	cst_2_pValidArray_0 <= forkC_22_validArray_0;
	forkC_22_nReadyArray_0 <= cst_2_readyArray_0;
	cst_2_dataInArray_0 <= "00000000000000000000000000000000";
	branchC_16_pValidArray_0 <= forkC_22_validArray_1;
	forkC_22_nReadyArray_1 <= branchC_16_readyArray_0;
	branchC_16_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_22_dataOutArray_1),branchC_16_dataInArray_0'length));

	branchC_16_clk <= clk;
	branchC_16_rst <= rst;
	phiC_12_pValidArray_0 <= branchC_16_validArray_0;
	branchC_16_nReadyArray_0 <= phiC_12_readyArray_0;
	phiC_12_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_16_dataOutArray_0),phiC_12_dataInArray_0'length));
	phiC_14_pValidArray_0 <= branchC_16_validArray_1;
	branchC_16_nReadyArray_1 <= phiC_14_readyArray_0;
	phiC_14_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_16_dataOutArray_1),phiC_14_dataInArray_0'length));
	...
	Buffer_9_clk <= clk;
	Buffer_9_rst <= rst;
	phi_n4_pValidArray_0 <= Buffer_9_validArray_0;
	Buffer_9_nReadyArray_0 <= phi_n4_readyArray_0;
	phi_n4_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_9_dataOutArray_0),phi_n4_dataInArray_0'length));

	Buffer_10_clk <= clk;
	Buffer_10_rst <= rst;
	phi_n5_pValidArray_0 <= Buffer_10_validArray_0;
	Buffer_10_nReadyArray_0 <= phi_n5_readyArray_0;
	phi_n5_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_10_dataOutArray_0),phi_n5_dataInArray_0'length));

	Buffer_16_clk <= clk;
	Buffer_16_rst <= rst;
	forkC_22_pValidArray_0 <= Buffer_16_validArray_0;
	Buffer_16_nReadyArray_0 <= forkC_22_readyArray_0;
	forkC_22_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_16_dataOutArray_0),forkC_22_dataInArray_0'length));
	...
	phi_n6_clk <= clk;
	phi_n6_rst <= rst;
	fork_10_pValidArray_0 <= phi_n6_validArray_0;
	phi_n6_nReadyArray_0 <= fork_10_readyArray_0;
	fork_10_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n6_dataOutArray_0),fork_10_dataInArray_0'length));

	phi_n7_clk <= clk;
	phi_n7_rst <= rst;
	branch_6_pValidArray_0 <= phi_n7_validArray_0;
	phi_n7_nReadyArray_0 <= branch_6_readyArray_0;
	branch_6_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n7_dataOutArray_0),branch_6_dataInArray_0'length));

	fork_10_clk <= clk;
	fork_10_rst <= rst;
	branch_7_pValidArray_0 <= fork_10_validArray_0;
	fork_10_nReadyArray_0 <= branch_7_readyArray_0;
	branch_7_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_10_dataOutArray_0),branch_7_dataInArray_0'length));
	branch_8_pValidArray_0 <= fork_10_validArray_1;
	fork_10_nReadyArray_1 <= branch_8_readyArray_0;
	branch_8_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_10_dataOutArray_1),branch_8_dataInArray_0'length));

	branch_6_clk <= clk;
	branch_6_rst <= rst;
	phi_n9_pValidArray_0 <= branch_6_validArray_0;
	branch_6_nReadyArray_0 <= phi_n9_readyArray_0;
	phi_n9_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_6_dataOutArray_0),phi_n9_dataInArray_0'length));
	sink_3_pValidArray_0 <= branch_6_validArray_1;
	branch_6_nReadyArray_1 <= sink_3_readyArray_0;
	sink_3_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_6_dataOutArray_1),sink_3_dataInArray_0'length));

	branch_7_clk <= clk;
	branch_7_rst <= rst;
	phi_n8_pValidArray_0 <= branch_7_validArray_0;
	branch_7_nReadyArray_0 <= phi_n8_readyArray_0;
	phi_n8_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_7_dataOutArray_0),phi_n8_dataInArray_0'length));
	sink_4_pValidArray_0 <= branch_7_validArray_1;
	branch_7_nReadyArray_1 <= sink_4_readyArray_0;
	sink_4_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_7_dataOutArray_1),sink_4_dataInArray_0'length));

	branch_8_clk <= clk;
	branch_8_rst <= rst;
	phi_8_pValidArray_1 <= branch_8_validArray_0;
	branch_8_nReadyArray_0 <= phi_8_readyArray_1;
	phi_8_dataInArray_1 <= std_logic_vector (resize(unsigned(branch_8_dataOutArray_0),phi_8_dataInArray_1'length));
	sink_5_pValidArray_0 <= branch_8_validArray_1;
	branch_8_nReadyArray_1 <= sink_5_readyArray_0;
	sink_5_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_8_dataOutArray_1),sink_5_dataInArray_0'length));

	fork_16_clk <= clk;
	fork_16_rst <= rst;
	branch_8_pValidArray_1 <= fork_16_validArray_0;
	fork_16_nReadyArray_0 <= branch_8_readyArray_1;
	branch_8_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_16_dataOutArray_0),branch_8_dataInArray_1'length));
	branch_7_pValidArray_1 <= fork_16_validArray_1;
	fork_16_nReadyArray_1 <= branch_7_readyArray_1;
	branch_7_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_16_dataOutArray_1),branch_7_dataInArray_1'length));
	branch_6_pValidArray_1 <= fork_16_validArray_2;
	fork_16_nReadyArray_2 <= branch_6_readyArray_1;
	branch_6_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_16_dataOutArray_2),branch_6_dataInArray_1'length));
	branchC_17_pValidArray_1 <= fork_16_validArray_3;
	fork_16_nReadyArray_3 <= branchC_17_readyArray_1;
	branchC_17_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_16_dataOutArray_3),branchC_17_dataInArray_1'length));

	phiC_12_clk <= clk;
	phiC_12_rst <= rst;
	forkC_23_pValidArray_0 <= phiC_12_validArray_0;
	phiC_12_nReadyArray_0 <= forkC_23_readyArray_0;
	forkC_23_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_12_dataOutArray_0),forkC_23_dataInArray_0'length));

	forkC_23_clk <= clk;
	forkC_23_rst <= rst;
	branchC_17_pValidArray_0 <= forkC_23_validArray_0;
	forkC_23_nReadyArray_0 <= branchC_17_readyArray_0;
	branchC_17_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_23_dataOutArray_0),branchC_17_dataInArray_0'length));
	brCst_block4_pValidArray_0 <= forkC_23_validArray_1;
	forkC_23_nReadyArray_1 <= brCst_block4_readyArray_0;
	brCst_block4_dataInArray_0 <= "1";

	branchC_17_clk <= clk;
	branchC_17_rst <= rst;
	phiC_13_pValidArray_0 <= branchC_17_validArray_0;
	branchC_17_nReadyArray_0 <= phiC_13_readyArray_0;
	phiC_13_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_17_dataOutArray_0),phiC_13_dataInArray_0'length));
	sink_8_pValidArray_0 <= branchC_17_validArray_1;
	branchC_17_nReadyArray_1 <= sink_8_readyArray_0;
	sink_8_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_17_dataOutArray_1),sink_8_dataInArray_0'length));

	phi_8_clk <= clk;
	phi_8_rst <= rst;
	fork_3_pValidArray_0 <= phi_8_validArray_0;
	phi_8_nReadyArray_0 <= fork_3_readyArray_0;
	fork_3_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_8_dataOutArray_0),fork_3_dataInArray_0'length));
	...
	add_9_clk <= clk;
	add_9_rst <= rst;
	Buffer_2_pValidArray_0 <= add_9_validArray_0;
	add_9_nReadyArray_0 <= Buffer_2_readyArray_0;
	Buffer_2_dataInArray_0 <= std_logic_vector (resize(unsigned(add_9_dataOutArray_0),Buffer_2_dataInArray_0'length));
	...
	fork_5_pValidArray_0 <= getelementptr_20_validArray_0;
	getelementptr_20_nReadyArray_0 <= fork_5_readyArray_0;
	fork_5_dataInArray_0 <= std_logic_vector (resize(unsigned(getelementptr_20_dataOutArray_0),fork_5_dataInArray_0'length));
	...
	icmp_23_clk <= clk;
	icmp_23_rst <= rst;
	Buffer_3_pValidArray_0 <= icmp_23_validArray_0;
	icmp_23_nReadyArray_0 <= Buffer_3_readyArray_0;
	Buffer_3_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_23_dataOutArray_0),Buffer_3_dataInArray_0'length));

	cst_7_clk <= clk;
	cst_7_rst <= rst;
	getelementptr_12_pValidArray_2 <= cst_7_validArray_0;
	cst_7_nReadyArray_0 <= getelementptr_12_readyArray_2;
	getelementptr_12_dataInArray_2 <= std_logic_vector (resize(unsigned(cst_7_dataOutArray_0),getelementptr_12_dataInArray_2'length));

	cst_8_clk <= clk;
	cst_8_rst <= rst;
	Buffer_5_pValidArray_0 <= cst_8_validArray_0;
	cst_8_nReadyArray_0 <= Buffer_5_readyArray_0;
	Buffer_5_dataInArray_0 <= std_logic_vector (resize(unsigned(cst_8_dataOutArray_0),Buffer_5_dataInArray_0'length));

	phi_n8_clk <= clk;
	phi_n8_rst <= rst;
	Buffer_6_pValidArray_0 <= phi_n8_validArray_0;
	phi_n8_nReadyArray_0 <= Buffer_6_readyArray_0;
	Buffer_6_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n8_dataOutArray_0),Buffer_6_dataInArray_0'length));

	phi_n9_clk <= clk;
	phi_n9_rst <= rst;
	Buffer_7_pValidArray_0 <= phi_n9_validArray_0;
	phi_n9_nReadyArray_0 <= Buffer_7_readyArray_0;
	Buffer_7_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n9_dataOutArray_0),Buffer_7_dataInArray_0'length));

	fork_3_clk <= clk;
	fork_3_rst <= rst;
	add_9_pValidArray_0 <= fork_3_validArray_0;
	fork_3_nReadyArray_0 <= add_9_readyArray_0;
	add_9_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_3_dataOutArray_0),add_9_dataInArray_0'length));
	icmp_23_pValidArray_0 <= fork_3_validArray_1;
	fork_3_nReadyArray_1 <= icmp_23_readyArray_0;
	icmp_23_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_3_dataOutArray_1),icmp_23_dataInArray_0'length));

	fork_4_clk <= clk;
	fork_4_rst <= rst;
	sext_10_pValidArray_0 <= fork_4_validArray_0;
	fork_4_nReadyArray_0 <= sext_10_readyArray_0;
	sext_10_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_4_dataOutArray_0),sext_10_dataInArray_0'length));
	Buffer_8_pValidArray_0 <= fork_4_validArray_1;
	fork_4_nReadyArray_1 <= Buffer_8_readyArray_0;
	Buffer_8_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_4_dataOutArray_1),Buffer_8_dataInArray_0'length));
	branch_9_pValidArray_0 <= fork_4_validArray_2;
	fork_4_nReadyArray_2 <= branch_9_readyArray_0;
	branch_9_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_4_dataOutArray_2),branch_9_dataInArray_0'length));

	fork_5_clk <= clk;
	fork_5_rst <= rst;
	load_21_pValidArray_1 <= fork_5_validArray_0;
	fork_5_nReadyArray_0 <= load_21_readyArray_1;
	load_21_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_5_dataOutArray_0),load_21_dataInArray_1'length));
	...
	fork_11_clk <= clk;
	fork_11_rst <= rst;
	sext_11_pValidArray_0 <= fork_11_validArray_0;
	fork_11_nReadyArray_0 <= sext_11_readyArray_0;
	sext_11_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_11_dataOutArray_0),sext_11_dataInArray_0'length));
	load_16_pValidArray_1 <= fork_11_validArray_1;
	fork_11_nReadyArray_1 <= load_16_readyArray_1;
	load_16_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_11_dataOutArray_1),load_16_dataInArray_1'length));
	branch_10_pValidArray_0 <= fork_11_validArray_2;
	fork_11_nReadyArray_2 <= branch_10_readyArray_0;
	branch_10_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_11_dataOutArray_2),branch_10_dataInArray_0'length));

	fork_12_clk <= clk;
	fork_12_rst <= rst;
	sext_19_pValidArray_0 <= fork_12_validArray_0;
	fork_12_nReadyArray_0 <= sext_19_readyArray_0;
	sext_19_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_12_dataOutArray_0),sext_19_dataInArray_0'length));
	...
	branch_9_clk <= clk;
	branch_9_rst <= rst;
	Buffer_11_pValidArray_0 <= branch_9_validArray_0;
	branch_9_nReadyArray_0 <= Buffer_11_readyArray_0;
	Buffer_11_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_9_dataOutArray_0),Buffer_11_dataInArray_0'length));
	sink_6_pValidArray_0 <= branch_9_validArray_1;
	branch_9_nReadyArray_1 <= sink_6_readyArray_0;
	sink_6_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_9_dataOutArray_1),sink_6_dataInArray_0'length));

	branch_10_clk <= clk;
	branch_10_rst <= rst;
	Buffer_12_pValidArray_0 <= branch_10_validArray_0;
	branch_10_nReadyArray_0 <= Buffer_12_readyArray_0;
	Buffer_12_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_10_dataOutArray_0),Buffer_12_dataInArray_0'length));
	phi_n4_pValidArray_1 <= branch_10_validArray_1;
	branch_10_nReadyArray_1 <= phi_n4_readyArray_1;
	phi_n4_dataInArray_1 <= std_logic_vector (resize(unsigned(branch_10_dataOutArray_1),phi_n4_dataInArray_1'length));

	branch_11_clk <= clk;
	branch_11_rst <= rst;
	phi_n9_pValidArray_1 <= branch_11_validArray_0;
	branch_11_nReadyArray_0 <= phi_n9_readyArray_1;
	phi_n9_dataInArray_1 <= std_logic_vector (resize(unsigned(branch_11_dataOutArray_0),phi_n9_dataInArray_1'length));
	phi_n5_pValidArray_1 <= branch_11_validArray_1;
	branch_11_nReadyArray_1 <= phi_n5_readyArray_1;
	phi_n5_dataInArray_1 <= std_logic_vector (resize(unsigned(branch_11_dataOutArray_1),phi_n5_dataInArray_1'length));

	fork_17_clk <= clk;
	fork_17_rst <= rst;
	Buffer_13_pValidArray_0 <= fork_17_validArray_0;
	fork_17_nReadyArray_0 <= Buffer_13_readyArray_0;
	Buffer_13_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_17_dataOutArray_0),Buffer_13_dataInArray_0'length));
	branch_10_pValidArray_1 <= fork_17_validArray_1;
	fork_17_nReadyArray_1 <= branch_10_readyArray_1;
	branch_10_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_17_dataOutArray_1),branch_10_dataInArray_1'length));
	branch_9_pValidArray_1 <= fork_17_validArray_2;
	fork_17_nReadyArray_2 <= branch_9_readyArray_1;
	branch_9_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_17_dataOutArray_2),branch_9_dataInArray_1'length));
	branchC_18_pValidArray_1 <= fork_17_validArray_3;
	fork_17_nReadyArray_3 <= branchC_18_readyArray_1;
	branchC_18_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_17_dataOutArray_3),branchC_18_dataInArray_1'length));
	...
	phiC_13_clk <= clk;
	phiC_13_rst <= rst;
	forkC_24_pValidArray_0 <= phiC_13_validArray_0;
	phiC_13_nReadyArray_0 <= forkC_24_readyArray_0;
	forkC_24_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_13_dataOutArray_0),forkC_24_dataInArray_0'length));
	phi_8_pValidArray_0 <= phiC_13_validArray_1;
	phiC_13_nReadyArray_1 <= phi_8_readyArray_0;
	phi_8_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_13_dataOutArray_1),phi_8_dataInArray_0'length));

	forkC_24_clk <= clk;
	forkC_24_rst <= rst;
	cst_3_pValidArray_0 <= forkC_24_validArray_0;
	forkC_24_nReadyArray_0 <= cst_3_readyArray_0;
	cst_3_dataInArray_0 <= "11111111111111111111111111111111";
	cst_4_pValidArray_0 <= forkC_24_validArray_1;
	forkC_24_nReadyArray_1 <= cst_4_readyArray_0;
	cst_4_dataInArray_0 <= "00000000000000000000000000000001";
	Buffer_17_pValidArray_0 <= forkC_24_validArray_2;
	forkC_24_nReadyArray_2 <= Buffer_17_readyArray_0;
	Buffer_17_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_24_dataOutArray_2),Buffer_17_dataInArray_0'length));
	cst_8_pValidArray_0 <= forkC_24_validArray_3;
	forkC_24_nReadyArray_3 <= cst_8_readyArray_0;
	cst_8_dataInArray_0 <= "00000000000000000000000001100100";
	LSQ_A_pValidArray_0 <= forkC_24_validArray_4;
	forkC_24_nReadyArray_4 <= LSQ_A_readyArray_0;
	LSQ_A_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_24_dataOutArray_4),LSQ_A_dataInArray_0'length));
	cst_9_pValidArray_0 <= forkC_24_validArray_5;
	forkC_24_nReadyArray_5 <= cst_9_readyArray_0;
	cst_9_dataInArray_0 <= "00000000000000000000000000000001";
	Buffer_18_pValidArray_0 <= forkC_24_validArray_6;
	forkC_24_nReadyArray_6 <= Buffer_18_readyArray_0;
	Buffer_18_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_24_dataOutArray_6),Buffer_18_dataInArray_0'length));

	branchC_18_clk <= clk;
	branchC_18_rst <= rst;
	Buffer_19_pValidArray_0 <= branchC_18_validArray_0;
	branchC_18_nReadyArray_0 <= Buffer_19_readyArray_0;
	Buffer_19_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_18_dataOutArray_0),Buffer_19_dataInArray_0'length));
	phiC_14_pValidArray_1 <= branchC_18_validArray_1;
	branchC_18_nReadyArray_1 <= phiC_14_readyArray_1;
	phiC_14_dataInArray_1 <= std_logic_vector (resize(unsigned(branchC_18_dataOutArray_1),phiC_14_dataInArray_1'length));

	Buffer_2_clk <= clk;
	Buffer_2_rst <= rst;
	fork_4_pValidArray_0 <= Buffer_2_validArray_0;
	Buffer_2_nReadyArray_0 <= fork_4_readyArray_0;
	fork_4_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_2_dataOutArray_0),fork_4_dataInArray_0'length));

	Buffer_3_clk <= clk;
	Buffer_3_rst <= rst;
	fork_17_pValidArray_0 <= Buffer_3_validArray_0;
	Buffer_3_nReadyArray_0 <= fork_17_readyArray_0;
	fork_17_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_3_dataOutArray_0),fork_17_dataInArray_0'length));

	Buffer_5_clk <= clk;
	Buffer_5_rst <= rst;
	getelementptr_20_pValidArray_2 <= Buffer_5_validArray_0;
	Buffer_5_nReadyArray_0 <= getelementptr_20_readyArray_2;
	getelementptr_20_dataInArray_2 <= std_logic_vector (resize(unsigned(Buffer_5_dataOutArray_0),getelementptr_20_dataInArray_2'length));

	Buffer_6_clk <= clk;
	Buffer_6_rst <= rst;
	fork_11_pValidArray_0 <= Buffer_6_validArray_0;
	Buffer_6_nReadyArray_0 <= fork_11_readyArray_0;
	fork_11_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_6_dataOutArray_0),fork_11_dataInArray_0'length));
	...
	Buffer_8_clk <= clk;
	Buffer_8_rst <= rst;
	sext_18_pValidArray_0 <= Buffer_8_validArray_0;
	Buffer_8_nReadyArray_0 <= sext_18_readyArray_0;
	sext_18_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_8_dataOutArray_0),sext_18_dataInArray_0'length));

	Buffer_11_clk <= clk;
	Buffer_11_rst <= rst;
	phi_8_pValidArray_2 <= Buffer_11_validArray_0;
	Buffer_11_nReadyArray_0 <= phi_8_readyArray_2;
	phi_8_dataInArray_2 <= std_logic_vector (resize(unsigned(Buffer_11_dataOutArray_0),phi_8_dataInArray_2'length));

	Buffer_12_clk <= clk;
	Buffer_12_rst <= rst;
	phi_n8_pValidArray_1 <= Buffer_12_validArray_0;
	Buffer_12_nReadyArray_0 <= phi_n8_readyArray_1;
	phi_n8_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_12_dataOutArray_0),phi_n8_dataInArray_1'length));

	Buffer_13_clk <= clk;
	Buffer_13_rst <= rst;
	branch_11_pValidArray_1 <= Buffer_13_validArray_0;
	Buffer_13_nReadyArray_0 <= branch_11_readyArray_1;
	branch_11_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_13_dataOutArray_0),branch_11_dataInArray_1'length));

	Buffer_17_clk <= clk;
	Buffer_17_rst <= rst;
	cst_7_pValidArray_0 <= Buffer_17_validArray_0;
	Buffer_17_nReadyArray_0 <= cst_7_readyArray_0;
	cst_7_dataInArray_0 <= "00000000000000000000000001100100";

	Buffer_18_clk <= clk;
	Buffer_18_rst <= rst;
	branchC_18_pValidArray_0 <= Buffer_18_validArray_0;
	Buffer_18_nReadyArray_0 <= branchC_18_readyArray_0;
	branchC_18_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_18_dataOutArray_0),branchC_18_dataInArray_0'length));

	Buffer_19_clk <= clk;
	Buffer_19_rst <= rst;
	phiC_13_pValidArray_1 <= Buffer_19_validArray_0;
	Buffer_19_nReadyArray_0 <= phiC_13_readyArray_1;
	phiC_13_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_19_dataOutArray_0),phiC_13_dataInArray_1'length));
	...
	add_25_clk <= clk;
	add_25_rst <= rst;
	branch_12_pValidArray_0 <= add_25_validArray_0;
	add_25_nReadyArray_0 <= branch_12_readyArray_0;
	branch_12_dataInArray_0 <= std_logic_vector (resize(unsigned(add_25_dataOutArray_0),branch_12_dataInArray_0'length));
	...
	icmp_26_clk <= clk;
	icmp_26_rst <= rst;
	fork_18_pValidArray_0 <= icmp_26_validArray_0;
	icmp_26_nReadyArray_0 <= fork_18_readyArray_0;
	fork_18_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_26_dataOutArray_0),fork_18_dataInArray_0'length));

	phi_n4_clk <= clk;
	phi_n4_rst <= rst;
	fork_8_pValidArray_0 <= phi_n4_validArray_0;
	phi_n4_nReadyArray_0 <= fork_8_readyArray_0;
	fork_8_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n4_dataOutArray_0),fork_8_dataInArray_0'length));

	phi_n5_clk <= clk;
	phi_n5_rst <= rst;
	branch_13_pValidArray_0 <= phi_n5_validArray_0;
	phi_n5_nReadyArray_0 <= branch_13_readyArray_0;
	branch_13_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_n5_dataOutArray_0),branch_13_dataInArray_0'length));

	fork_8_clk <= clk;
	fork_8_rst <= rst;
	add_25_pValidArray_0 <= fork_8_validArray_0;
	fork_8_nReadyArray_0 <= add_25_readyArray_0;
	add_25_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_8_dataOutArray_0),add_25_dataInArray_0'length));
	icmp_26_pValidArray_0 <= fork_8_validArray_1;
	fork_8_nReadyArray_1 <= icmp_26_readyArray_0;
	icmp_26_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_8_dataOutArray_1),icmp_26_dataInArray_0'length));

	branch_12_clk <= clk;
	branch_12_rst <= rst;
	phi_4_pValidArray_2 <= branch_12_validArray_0;
	branch_12_nReadyArray_0 <= phi_4_readyArray_2;
	phi_4_dataInArray_2 <= std_logic_vector (resize(unsigned(branch_12_dataOutArray_0),phi_4_dataInArray_2'length));
	phi_28_pValidArray_2 <= branch_12_validArray_1;
	branch_12_nReadyArray_1 <= phi_28_readyArray_2;
	phi_28_dataInArray_2 <= std_logic_vector (resize(unsigned(branch_12_dataOutArray_1),phi_28_dataInArray_2'length));

	branch_13_clk <= clk;
	branch_13_rst <= rst;
	phi_n3_pValidArray_1 <= branch_13_validArray_0;
	branch_13_nReadyArray_0 <= phi_n3_readyArray_1;
	phi_n3_dataInArray_1 <= std_logic_vector (resize(unsigned(branch_13_dataOutArray_0),phi_n3_dataInArray_1'length));
	Buffer_14_pValidArray_0 <= branch_13_validArray_1;
	branch_13_nReadyArray_1 <= Buffer_14_readyArray_0;
	Buffer_14_dataInArray_0 <= std_logic_vector (resize(unsigned(branch_13_dataOutArray_1),Buffer_14_dataInArray_0'length));

	fork_18_clk <= clk;
	fork_18_rst <= rst;
	Buffer_15_pValidArray_0 <= fork_18_validArray_0;
	fork_18_nReadyArray_0 <= Buffer_15_readyArray_0;
	Buffer_15_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_18_dataOutArray_0),Buffer_15_dataInArray_0'length));
	branch_12_pValidArray_1 <= fork_18_validArray_1;
	fork_18_nReadyArray_1 <= branch_12_readyArray_1;
	branch_12_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_18_dataOutArray_1),branch_12_dataInArray_1'length));
	branchC_19_pValidArray_1 <= fork_18_validArray_2;
	fork_18_nReadyArray_2 <= branchC_19_readyArray_1;
	branchC_19_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_18_dataOutArray_2),branchC_19_dataInArray_1'length));

	phiC_14_clk <= clk;
	phiC_14_rst <= rst;
	forkC_25_pValidArray_0 <= phiC_14_validArray_0;
	phiC_14_nReadyArray_0 <= forkC_25_readyArray_0;
	forkC_25_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_14_dataOutArray_0),forkC_25_dataInArray_0'length));

	forkC_25_clk <= clk;
	forkC_25_rst <= rst;
	cst_5_pValidArray_0 <= forkC_25_validArray_0;
	forkC_25_nReadyArray_0 <= cst_5_readyArray_0;
	cst_5_dataInArray_0 <= "11111111111111111111111111111111";
	cst_6_pValidArray_0 <= forkC_25_validArray_1;
	forkC_25_nReadyArray_1 <= cst_6_readyArray_0;
	cst_6_dataInArray_0 <= "00000000000000000000000000000000";
	branchC_19_pValidArray_0 <= forkC_25_validArray_2;
	forkC_25_nReadyArray_2 <= branchC_19_readyArray_0;
	branchC_19_dataInArray_0 <= std_logic_vector (resize(unsigned(forkC_25_dataOutArray_2),branchC_19_dataInArray_0'length));

	branchC_19_clk <= clk;
	branchC_19_rst <= rst;
	phiC_11_pValidArray_1 <= branchC_19_validArray_0;
	branchC_19_nReadyArray_0 <= phiC_11_readyArray_1;
	phiC_11_dataInArray_1 <= std_logic_vector (resize(unsigned(branchC_19_dataOutArray_0),phiC_11_dataInArray_1'length));
	phiC_15_pValidArray_1 <= branchC_19_validArray_1;
	branchC_19_nReadyArray_1 <= phiC_15_readyArray_1;
	phiC_15_dataInArray_1 <= std_logic_vector (resize(unsigned(branchC_19_dataOutArray_1),phiC_15_dataInArray_1'length));

	Buffer_14_clk <= clk;
	Buffer_14_rst <= rst;
	phi_n2_pValidArray_1 <= Buffer_14_validArray_0;
	Buffer_14_nReadyArray_0 <= phi_n2_readyArray_1;
	phi_n2_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_14_dataOutArray_0),phi_n2_dataInArray_1'length));

	Buffer_15_clk <= clk;
	Buffer_15_rst <= rst;
	branch_13_pValidArray_1 <= Buffer_15_validArray_0;
	Buffer_15_nReadyArray_0 <= branch_13_readyArray_1;
	branch_13_dataInArray_1 <= std_logic_vector (resize(unsigned(Buffer_15_dataOutArray_0),branch_13_dataInArray_1'length));

	phi_28_clk <= clk;
	phi_28_rst <= rst;
	Buffer_4_pValidArray_0 <= phi_28_validArray_0;
	phi_28_nReadyArray_0 <= Buffer_4_readyArray_0;
	Buffer_4_dataInArray_0 <= std_logic_vector (resize(unsigned(phi_28_dataOutArray_0),Buffer_4_dataInArray_0'length));
	...
	phi_n2_clk <= clk;
	phi_n2_rst <= rst;
	add_29_pValidArray_1 <= phi_n2_validArray_0;
	phi_n2_nReadyArray_0 <= add_29_readyArray_1;
	add_29_dataInArray_1 <= std_logic_vector (resize(unsigned(phi_n2_dataOutArray_0),add_29_dataInArray_1'length));

	phiC_15_clk <= clk;
	phiC_15_rst <= rst;
	sink_0_pValidArray_0 <= phiC_15_validArray_0;
	phiC_15_nReadyArray_0 <= sink_0_readyArray_0;
	sink_0_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_15_dataOutArray_0),sink_0_dataInArray_0'length));
	phi_28_pValidArray_0 <= phiC_15_validArray_1;
	phiC_15_nReadyArray_1 <= phi_28_readyArray_0;
	phi_28_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_15_dataOutArray_1),phi_28_dataInArray_0'length));

	Buffer_4_clk <= clk;
	Buffer_4_rst <= rst;
	add_29_pValidArray_0 <= Buffer_4_validArray_0;
	Buffer_4_nReadyArray_0 <= add_29_readyArray_0;
	add_29_dataInArray_0 <= std_logic_vector (resize(unsigned(Buffer_4_dataOutArray_0),add_29_dataInArray_0'length));
...
fork_13: entity work.fork(arch) generic map (1,3,1,1)
port map (
	clk => fork_13_clk,
	rst => fork_13_rst,
...
fork_15: entity work.fork(arch) generic map (1,3,1,1)
port map (
	clk => fork_15_clk,
	rst => fork_15_rst,
...
fork_16: entity work.fork(arch) generic map (1,4,1,1)
port map (
	clk => fork_16_clk,
	rst => fork_16_rst,
...
fork_4: entity work.fork(arch) generic map (1,3,32,32)
port map (
	clk => fork_4_clk,
	rst => fork_4_rst,
...
fork_17: entity work.fork(arch) generic map (1,4,1,1)
port map (
	clk => fork_17_clk,
	rst => fork_17_rst,
...
forkC_24: entity work.fork(arch) generic map (1,7,1,1)
port map (
	clk => forkC_24_clk,
	rst => forkC_24_rst,
	...
	nReadyArray(4) => forkC_24_nReadyArray_4,
	nReadyArray(5) => forkC_24_nReadyArray_5,
	nReadyArray(6) => forkC_24_nReadyArray_6,
	...
	validArray(4) => forkC_24_validArray_4,
	validArray(5) => forkC_24_validArray_5,
	validArray(6) => forkC_24_validArray_6,
	...
	dataOutArray(4) => forkC_24_dataOutArray_4,
	dataOutArray(5) => forkC_24_dataOutArray_5,
	dataOutArray(6) => forkC_24_dataOutArray_6
);
...
Buffer_5: entity work.nontranspFifo(arch) generic map (1,1,32,32,3)
port map (
	clk => Buffer_5_clk,
	rst => Buffer_5_rst,
...
Buffer_13: entity work.TEHB(arch) generic map (1,1,1,1)
port map (
	clk => Buffer_13_clk,
	rst => Buffer_13_rst,
...
Buffer_19: entity work.TEHB(arch) generic map (1,1,1,1)
port map (
	clk => Buffer_19_clk,
	rst => Buffer_19_rst,
...
fork_18: entity work.fork(arch) generic map (1,3,1,1)
port map (
	clk => fork_18_clk,
	rst => fork_18_rst,
...
forkC_25: entity work.fork(arch) generic map (1,3,1,1)
port map (
	clk => forkC_25_clk,
	rst => forkC_25_rst,
