...
for.cond:                                         ; preds = %for.inc22, %entry
  %t.0 = phi i32 [ 0, %entry ], [ %inc23, %for.inc22 ]
...
for.cond12:                                       ; preds = %for.inc19, %for.end
  %j.0 = phi i32 [ 1, %for.end ], [ %inc20, %for.inc19 ]
...
for.end20:                                        ; preds = %for.cond
  ...
  %call30 = call i32 @_Z9jacobi_1dPiS_S_(i32* %arraydecay, i32* %arraydecay26, i32* %arraydecay29)
  ret i32 0
}
