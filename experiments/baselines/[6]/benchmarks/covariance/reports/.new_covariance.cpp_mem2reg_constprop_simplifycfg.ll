; ModuleID = '.new_covariance.cpp_mem2reg_constprop.ll'
...
for.end:                                          ; preds = %for.body3
  %m.0.lcssa = phi i32 [ %add, %for.body3 ]
...
for.end43:                                        ; preds = %for.body30
  %c.0.lcssa = phi i32 [ %add40, %for.body30 ]
...
for.inc52:                                        ; preds = %for.body23, %for.end43
...
for.end44:                                        ; preds = %for.body37
  %m.0.lcssa = phi i32 [ %add, %for.body37 ]
  %mul = mul nsw i32 %m.0.lcssa, 2
  br label %for.body48
...
for.body69:                                       ; preds = %for.body69, %for.body66
  ...
  %c.01 = phi i32 [ 0, %for.body66 ], [ %add79, %for.body69 ]
...
for.end82:                                        ; preds = %for.body69
  %c.0.lcssa = phi i32 [ %add79, %for.body69 ]
...
for.inc95:                                        ; preds = %for.body62, %for.end82
