...
# 2 "../C_SRC/triangular.cpp.tmp.c" 2
# 1 "../C_SRC/triangular.h" 1

# 1 "../C_SRC/triangular.h"
typedef int in_int_t;
typedef int inout_int_t;

int triangular( in_int_t x[100], inout_int_t A[100][100] , in_int_t n);
# 3 "../C_SRC/triangular.cpp.tmp.c" 2
...
int triangular( in_int_t x[100], inout_int_t A[100][100] , in_int_t n) {
	...
	for(hlsv_i0 = 0; hlsv_i0 < 100; hlsv_i0++){
		for(hlsv_i1 = 0; hlsv_i1 < 100; hlsv_i1++){
...
# 20 "../C_SRC/triangular.cpp.tmp.c" 2




# 23 "../C_SRC/triangular.cpp.tmp.c"
int main(void){
 in_int_t xArray[1][100];
 in_int_t A[1][100][100];
 in_int_t n[1];
