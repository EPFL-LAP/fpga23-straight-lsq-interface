; ModuleID = '.jacobi_1d_imper.cpp_mem2reg_constprop_simplifycfg.ll'
...
for.end20:                                        ; preds = %for.inc18
  ...
  %call30 = call i32 @_Z15jacobi_1d_imperPiS_S_(i32* nonnull %arraydecay, i32* nonnull %arraydecay26, i32* nonnull %arraydecay29)
  ret i32 0
}
