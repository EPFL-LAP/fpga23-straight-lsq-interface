; ModuleID = '.new_covariance.cpp_mem2reg_constprop_simplifycfg.ll'
...
for.end97:                                        ; preds = %for.inc95
  ...
  %call99 = call i32 @_Z14new_covariancePA32_iS0_([32 x i32]* nonnull %arraydecay, [32 x i32]* nonnull %arraydecay98)
  ret i32 0
}
