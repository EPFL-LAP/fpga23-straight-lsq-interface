; ModuleID = '_build/a1/a1_mem2reg.ll'
...
for.body:                                         ; preds = %entry, %for.inc
  ...
  %val_1.addr.03 = phi i32 [ %val_1, %entry ], [ %add, %for.inc ]
...
for.end:                                          ; preds = %for.inc
  %val_1.addr.0.lcssa = phi i32 [ %add, %for.inc ]
...
for.body8:                                        ; preds = %if.else, %for.inc12
  %i5.02 = phi i32 [ 0, %if.else ], [ %inc13, %for.inc12 ]
  %val_2.addr.01 = phi i32 [ %val_2, %if.else ], [ %add11, %for.inc12 ]
