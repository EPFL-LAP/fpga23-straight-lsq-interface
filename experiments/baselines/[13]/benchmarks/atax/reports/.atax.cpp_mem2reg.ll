...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %t.0 = phi i32 [ %0, %for.body ], [ %add, %for.inc ]
...
for.cond10:                                       ; preds = %for.inc23, %for.end
  %j.1 = phi i32 [ 0, %for.end ], [ %inc24, %for.inc23 ]
  %cmp11 = icmp slt i32 %j.1, 20
...
for.end25:                                        ; preds = %for.cond10
  ...
  store i32 %t.0, i32* %arrayidx27, align 4
  br label %for.inc28
...
for.cond15:                                       ; preds = %for.inc, %for.body3
  %x14.0 = phi i32 [ 0, %for.body3 ], [ %inc, %for.inc ]
  %cmp16 = icmp slt i32 %x14.0, 20
...
for.body17:                                       ; preds = %for.cond15
  ...
  %idxprom24 = sext i32 %x14.0 to i64
