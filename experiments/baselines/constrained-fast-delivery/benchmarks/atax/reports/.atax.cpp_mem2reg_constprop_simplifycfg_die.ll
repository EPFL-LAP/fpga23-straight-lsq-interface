; ModuleID = '.atax.cpp_mem2reg_constprop_simplifycfg.ll'
...
for.body3:                                        ; preds = %for.body3, %for.body
  %t.02 = phi i32 [ %1, %for.body ], [ %add, %for.body3 ]
  %j.01 = phi i32 [ 0, %for.body ], [ %inc, %for.body3 ]
  %2 = zext i32 %i.04 to i64
  %3 = zext i32 %j.01 to i64
  %arrayidx7 = getelementptr inbounds [20 x i32], [20 x i32]* %A, i64 %2, i64 %3
  %4 = load i32, i32* %arrayidx7, align 4
  %5 = zext i32 %j.01 to i64
  %arrayidx9 = getelementptr inbounds i32, i32* %x, i64 %5
...
for.body12:                                       ; preds = %for.body12, %for.end
  ...
  %7 = zext i32 %j.13 to i64
  %arrayidx14 = getelementptr inbounds i32, i32* %y, i64 %7
  %8 = load i32, i32* %arrayidx14, align 4
  %9 = zext i32 %i.04 to i64
  %10 = zext i32 %j.13 to i64
  %arrayidx18 = getelementptr inbounds [20 x i32], [20 x i32]* %A, i64 %9, i64 %10
  %11 = load i32, i32* %arrayidx18, align 4
  %mul19 = mul nsw i32 %11, %add
  %add20 = add nsw i32 %8, %mul19
  %12 = zext i32 %j.13 to i64
  %arrayidx22 = getelementptr inbounds i32, i32* %y, i64 %12
...
for.end25:                                        ; preds = %for.body12
  %13 = zext i32 %i.04 to i64
  %arrayidx27 = getelementptr inbounds i32, i32* %tmp, i64 %13
